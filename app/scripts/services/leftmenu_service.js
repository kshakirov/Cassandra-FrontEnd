magento_module.service("LeftMenuService", function (FiltersAggregationService,
  ...
  function _get_not_changed_current_filters(selected_filter_str, original_filters) {
    if(selected_filter_str && typeof selected_filter_str == 'string') {
      ...
      angular.forEach(original_filters, function (original, original_key) {
        if (original.code != selected_filter.code) {
          found = true;
  ...
  function _reaggregate_current_integer_filters(selected_filters, original_filters,
                                                current_filters, selected_filter_str) {
    var not_changed_filters = _get_not_changed_current_filters(selected_filter_str,
    original_filters);
    var aggs_query = '';
