magento_module.service('ElasticQuery', function ($cookies,
  ...
  function _add_not_external_manfr_filter(field, value) {
    var filter = {};
    angular.copy(not_external_filter, filter);
    filter.bool.must.wildcard[field] = value;
    return filter;
  }


  function _add_external_manfr_filter(field, value) {
    var filter = {};
    angular.copy(external_filter, filter);
    filter.bool.must[0].wildcard[field] = value;
    return filter;
  }
